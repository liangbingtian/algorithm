...
sum(clicks) AS '点击量',
case when max(basic_jd_udf_adserving_longines_campaign_set.type) is null then '无产品分类'
else max(basic_jd_udf_adserving_longines_campaign_set.type) end as '计划名称',
